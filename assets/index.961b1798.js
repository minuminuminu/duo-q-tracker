var S=Object.defineProperty;var b=Object.getOwnPropertySymbols;var k=Object.prototype.hasOwnProperty,j=Object.prototype.propertyIsEnumerable;var p=(e,t,o)=>t in e?S(e,t,{enumerable:!0,configurable:!0,writable:!0,value:o}):e[t]=o,m=(e,t)=>{for(var o in t||(t={}))k.call(t,o)&&p(e,o,t[o]);if(b)for(var o of b(t))j.call(t,o)&&p(e,o,t[o]);return e};import{W as O,U as C,s as r,j as x,u as y,R as w,A as I,a as F,b as N,r as u,c as z}from"./vendor.e4beda62.js";const L=function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))a(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const f of s.addedNodes)f.tagName==="LINK"&&f.rel==="modulepreload"&&a(f)}).observe(document,{childList:!0,subtree:!0});function o(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerpolicy&&(s.referrerPolicy=i.referrerpolicy),i.crossorigin==="use-credentials"?s.credentials="include":i.crossorigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(i){if(i.ep)return;i.ep=!0;const s=o(i);fetch(i.href,s)}};L();const M=O`
  *{
    margin:0;
...
`,V=e=>{const{register:t,resetField:o,handleSubmit:a}=y();return n(G,{children:c(q,{onSubmit:a(s=>{s.entry===""?alert("You need to enter a valid name!"):(e.setLocalStorage({[s.entry.toLowerCase()]:{wins:0,losses:0}}),o("entry"))}),children:[n(K,m({type:"text",autoComplete:"off",placeholder:"New Duo Entry"},t("entry"))),n(Q,{children:"Add Tracker"})]})})},H=r.div`
  width: 100%;
  height: 80%;
  display: grid;
